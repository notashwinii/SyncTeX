    ...
    <div className="w-screen h-screen bg-[#f8f9fa] flex flex-col items-start justify-start overflow-hidden">
      ...
      <SplitPane split="vertical" minSize={150} defaultSize={300} className="flex flex-grow">
        <div className="flex flex-col w-full border-r bg-white p-6">
          <Link
            to="/editor/new"
            className="bg-[#0097A7] hover:bg-[#00A79D] h-12 flex items-center justify-center text-white font-bold py-2 px-4 rounded-lg mb-4"
            onClick={handleNewProject}
          >
            New Project
          </Link>
          <button
            className="bg-[#0097A7] hover:bg-[#00A79D] h-12 flex items-center justify-center text-white font-bold py-2 px-4 rounded-lg"
